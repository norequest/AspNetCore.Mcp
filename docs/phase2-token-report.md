...
`McpEndpoints.TokenReport` is an offline, deterministic analyzer that tells you what your
...
Namespace `McpEndpoints.TokenReport`:
...
McpEndpoints generator could emit a tool manifest at build time that feeds this analyzer
